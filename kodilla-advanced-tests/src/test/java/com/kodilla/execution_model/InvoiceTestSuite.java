...
public class InvoiceTestSuite {
    ...
    @BeforeEach // adnotacja wywołana przed uruchomieniem każdego testu
    ...
    @AfterEach // adnotacja wywołana po uruchomieniu każdego testu
    public void resetValues() {
        System.out.println("Resetting values...");
    }

    @BeforeAll // przed startem wszystkich testów
    public static void displayIntroMessage() {
        System.out.println("Starting testing");
    }

    @AfterAll // po zakończeniu wszystkich testów
